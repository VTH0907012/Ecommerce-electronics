        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Chuyên cung cấp thiết bị điện tử chính hãng, uy tín, chất lượng với giá cả cạnh tranh nhất thị trường.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <span className="ml-3 text-gray-400">3/2 Quận Ninh Kiều, Thành Phó Cần Thơ</span>
              </div>
              <div className="flex items-center">
          ...
          <div className="space-y-4">
            ...
            <form className="mt-2 flex">
              <input 
                ...
                className="flex-grow px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-700 text-white"
                required
              />
              <button 
                type="submit" 
                className="px-4 py-2 rounded-r-md bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors"
              >
                Gửi
              </button>
            </form>
